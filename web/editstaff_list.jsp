...
window.open("http://localhost:8082/bus/admin.jsp?name="+name);
//var name = "roseindia";
 ...
 /*   if(name2.isEmpty()){
    ...
    <div class="first" style="width:100%;height:45px;">
      <h2 class="fleft topnav-name" title="name" style="padding-right:10px !important;passing-left:10px !important;">ONLINE BUS TICKET BOOKING SYSTEM</h2>
        <a class="fright f-item "  onclick="location.href='index.jsp';" target="_blank" title="login" style="padding-right:10px !important; padding-left:10px !important; color:white;"> Logout </a>
   ...
   <div class="container1" style="width:100%;height:80%;position:absolute;">
                   ...
                   <table border="1" style="height:50px;width: 1000px;">
                    ...
                    System.out.println("list:"+name2);
                     ...
                     <td><% out.println(rs.getString(3)); %></td>
                        ...
                        <td><button id="edit" value="<%  out.println(rs.getString(6)); %>" onclick="location.href='editstaff.jsp?name=<%=name2%>&id=<%=id%>';">Edit</button>
                        <button id="delete" value="<%  out.println(rs.getString(6)); %>" onclick="location.href='deletestaff.jsp?name=<%=name2%>&id=<%=id%>';">Delete</button></td>
       ...
       <tr>
          <button id="back"  onclick="location.href='admin.jsp';">Back</button>
      </tr>
            </table>
   </div>
