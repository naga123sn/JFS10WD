...
<html>
    ...
    <body id="view">
         <div id="title">
            ...
            <p>Enhance your Reading skill with our wide range of Feedback Information</p>
        </div>
       ...
       <table border="1">
           ...
           <%
               try{
                   ...
                   String updatequery = "UPDATE addfeedback SET feedback=?,where name=?";
                   PreparedStatement pt = con.prepareStatement(feedback);
                   System.out.println(updatequery);
                   System.out.println("co"+book);
                   System.out.println("co"+name);
                   System.out.println("co"+feedback);
