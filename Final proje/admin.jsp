...
window.open("http://localhost:8082/bus/billadmin.jsp");
...
//window.open("Register.jsp");
window.open("http://localhost:8082/bus/busdetail.jsp?name="+name);
...
//window.open("Register.jsp");
window.open("http://localhost:8082/bus/userdetail.jsp");
    ...
    String name2 = (String) request.getAttribute("name");
     ...
     %>
                 ...
                 <div class="first" style="width:100%;height:45px;">
                     ...
                     <div class="dropdown fright">
                           <button class="dropbtn" onclick="location.href='billadmin.jsp';">Payments</button>
                          </div>
                      
                        <div class="dropdown fright">
                          <button class="dropbtn" onclick="location.href='userdetail.jsp';">User</button>
                          </div>
                      <div class="dropdown  fright">
                          <button class="dropbtn">Bus</button>
                        <div class="dropdown-content">
                           
                          <a  onclick="location.href='add_bus_list.jsp';">Add Bus</a>
                      ...
                      <div class="dropdown  fright">
                        ...
                        <div class="dropdown-content">
                          ...
                          <a onclick="location.href='add_staff.jsp';">Add Staff</a>
                          <a onclick="location.href='editstaff_list.jsp';">Update/Delete Staff </a>
                        </div>
                      </div>
