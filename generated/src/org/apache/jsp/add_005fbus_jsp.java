...
ResultSet rs =null;
 ...
 String name3 = (String) request.getParameter("name");
   System.out.println("jsname:"+name3);
      ...
      out.write("\n");
      out.write("  <form name=\"add_staff\" class=\"registartion-form\" action=\"add_bus\" method=\"post\">\n");
      out.write("      <table> \n");
      out.write("         <h1 style='color:black;'>Add Bus</h1>\n");
      out.write("         ");
 String name2 = (String) request.getParameter("name"); 
      out.write("\n");
      out.write("         <tr>\n");
      out.write("        <td><label for=\"hospital\">Bus Number</label></td>\n");
      out.write("        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" name=\"no\" id=\"staffname\" placeholder=\"Ex: 1\" required=\"required\"></td>\n");
      out.write("      </tr>\n");
      out.write("      <tr>\n");
      out.write("        <td><label for=\"hospital\">Bus Name</label></td>\n");
      out.write("        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" name=\"busname\" id=\"staffname\" placeholder=\"Ex: Volvo\" required=\"required\"></td>\n");
      out.write("      </tr>\n");
      out.write("      \n");
      out.write("      <tr>\n");
      out.write("        <td><label for=\"hospital\">Model</label></td>\n");
      out.write("        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" name=\"model\" id=\"staffname\" placeholder=\"Ex: y4\" required=\"required\"></td>\n");
      out.write("      </tr>\n");
      out.write("      <tr>\n");
      out.write("        <td><label for=\"hospital\">Register Number</label></td>\n");
      out.write("        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" name=\"reg\" id=\"staffname\" placeholder=\"Ex: TN47 cz2345 \" required=\"required\"></td>\n");
      out.write("      </tr>\n");
      out.write("     <tr>\n");
      out.write("        <td><label for=\"hospital\">Type</label></td>\n");
      out.write("        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" name=\"type\" id=\"staffname\" placeholder=\"Ex: AC\" required=\"required\"></td>\n");
      out.write("      </tr>\n");
      out.write("     \n");
      out.write("  \n");
      out.write("      \n");
      out.write("      <tr>\n");
      out.write("        <td colspan=\"2\"><input type=\"submit\" class=\"submit\" value=\"Add \" /></td>\n");
      out.write("      </tr>\n");
      out.write("      <tr>\n");
 ...
 if(aSuccess=="Staff Details Added Successfully"){ 
      out.write("\n");
      out.write("    <script>\n");
      out.write("        alert(\"Bus Details Added Successfully\");\n");
      out.write("        \n");
      out.write("        </script>");
 } 
      out.write("\n");
